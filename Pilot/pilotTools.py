...
try:
    from Pilot.proxyTools import getVO, BaseRequest, TokenBasedRequest
except ImportError:
    from proxyTools import getVO, BaseRequest, TokenBasedRequest
...
def sendMessage(diracx_URL, pilotUUID, jwt={}, rawMessage = []):
    """
